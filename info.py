...
PRIME_LOGO = (environ.get('PRIME_LOGO', 'https://i.ibb.co/bMRRt9gp/photo-2024-12-15-13-42-18-7484275667727548420.jpg'))
...
# PREMIUM ACCESS *
lazydownloaders = [int(lazydownloaders) if id_pattern.search(lazydownloaders) else lazydownloaders for lazydownloaders in environ.get('PRIME_DOWNLOADERS', '5787359348 1980293755').split()]
PRIME_USERS = (lazydownloaders) if lazydownloaders else [] # users who can get & download file without url shortner
lazy_renamers = [int(lazrenamers) if id_pattern.search(lazrenamers) else lazrenamers for lazrenamers in environ.get('LAZY_RENAMERS', '5787359348 1980293755').split()]
...
LZURL_PRIME_USERS = [int(lazyurlers) if id_pattern.search(lazyurlers) else lazyurlers for lazyurlers in environ.get('LZURL_PRIME_USERS', '5787359348 1980293755').split()]

QR_CODE_IMG = environ.get('QR_CODE_IMG','https://i.ibb.co/bMRRt9gp/photo-2024-12-15-13-42-18-7484275667727548420.jpg') #add url link of your qr code to recieve money - use telegraph bot or other source to get image
UPI_ID = environ.get('UPI_ID', '7340443594@ybl') #enter your upi id here - grab it from your online payment methods.

# Others
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/LarvaLinks') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MovieWalaChat')
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','BhardwajBhait') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','LarvaLinks') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','DM_HUB_069') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','BBkiVines')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "DM_HUB_69") #[ without @ ]
...
my_users = [int(my_users) if id_pattern.search(my_users) else my_users for my_users in environ.get('MY_USERS', '5787359348 1980293755').split()]
...
DISCUSSION_CHAT_USRNM = "MovieWalaChat" #without @

# Download Tutorial Button #
DOWNLOAD_TEXT_NAME = "⚓How to Download⚓"
DOWNLOAD_TEXT_URL = "https://t.me/LarvaLinks"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/+P2DsdtaXAjlkMWM1"
